...
const ReviewCardList = (props) => (
    <SimpleGrid columns={{base: 1, sm: 2, md: 4}} spacing={3}>
        ...
        <ReviewCard name="Weiyoung Tan" imageUrl="" rating="5" reviewTitle="I love it"
                    reviewSummary="Neither do I"/>
        <ReviewCard name="Raghav" imageUrl="" rating="5" reviewTitle="Amazing job"
                    reviewSummary="I like how interactive the website is. It has a nice UI."/>
        <ReviewCard name="Paul" imageUrl="" rating="5" reviewTitle="Can't ask for any better"
