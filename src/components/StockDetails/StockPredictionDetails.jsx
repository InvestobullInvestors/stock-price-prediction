...
import {Box, Grid, GridItem, Heading, SimpleGrid, useColorModeValue, VStack} from "@chakra-ui/react";
import {usePrediction} from "../../contexts/usePredictions";
import PredictionSlider from "./PredictionSlider";

const CustomGridItem = ({children, ...otherProps}) => (
    <GridItem mx={4} my={4} borderRadius="lg" shadow="none" colSpan={3} {...otherProps}>
        {children}
    </GridItem>
)
...
const PricePrediction = () => (
    <CustomGridItem>
        <VStack spacing={4}>
            ...
            <CustomContainer p={4} w="80%" bgColor={useColorModeValue("brand.300", "brand.600")}
                             borderRadius="lg">
                <VStack spacing={4}>
                    ...
                    <Box p={4} w="100%" bgColor={useColorModeValue("brand.100", "brand.500")} borderRadius="lg">
                        <SimpleGrid columns={{base: 1, lg: 2}} spacing={1}>
                            <Heading as="h3" size="lg">1 Month</Heading>
                            <Heading as="h3" size="lg" color="lightgreen">690.25</Heading>
                        </SimpleGrid>
                    </Box>
                    <Box p={4} w="100%" bgColor={useColorModeValue("brand.100", "brand.500")} borderRadius="lg">
                        <SimpleGrid columns={{base: 1, lg: 2}} spacing={1}>
                            <Heading as="h3" size="lg">1 Year</Heading>
                            <Heading as="h3" size="lg" color="lightgreen">700.25</Heading>
                        </SimpleGrid>
                    </Box>
                </VStack>
            </CustomContainer>
